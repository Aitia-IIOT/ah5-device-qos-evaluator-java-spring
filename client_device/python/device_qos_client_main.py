...
from ram_used_2_1.ram_used_2_1 import start_measuring_ram, get_batch_ram, stop_measuring_ram
...
cpu_enabled = config.get('measurements', {}).get('cpu_total_load_1_4', {}).get('enabled', False)
ram_enabled = config.get('measurements', {}).get('ram_used_2_1', {}).get('enabled', False)
net_enabled = config.get('measurements', {}).get('network_throughput_3_2', {}).get('enabled', False)
